...
var makeList = (data) => {
    ...
    data.forEach((el) => {
        ...
        li.addEventListener("mouseenter", (event) => { event.target.style.background = "rgb(233, 229, 229)"});
        li.addEventListener("mouseleave", (event) => { event.target.style.background = origColorStyle })
